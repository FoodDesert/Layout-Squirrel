...
class ComfyWorkflow:
    ...
    def sampler_custom_advanced(
        ...
        return self.add(
            ...
            output_count=2,
            noise=noise or self.random_noise(seed),
            guider=guider,
    ...
    def layout_squirrel_latent_color_hint(
        self,
        latent: Output,
        image: Output,
        mask: Output,
        ...
        return self.add(
            "ETN_LayoutSquirrelLatentColorHint",
            1,
            samples=latent,
            image=image,
            mask=mask,
    ...
    def layout_squirrel_color_noise(
        self,
        seed: int,
        image: Output,
        mask: Output,
    ...
    def layout_squirrel_color_noise_preview(
        self,
        latent: Output,
        seed: int,
        image: Output,
        ...
        return self.add(
            "ETN_LayoutSquirrelColorNoisePreview",
            1,
            samples=latent,
            seed=seed,
            image=image,
