...
class ComfyWorkflow:
    ...
    def define_region(self, regions: Output | None, mask: Output, conditioning: Output):
        inputs: dict[str, Input] = {"mask": mask, "conditioning": conditioning}
        if regions is not None:
            inputs["regions"] = regions
        return self.add("ETN_DefineRegion", 1, **inputs)
